...
impl AppError {
    ...
    pub fn not_available<S: Into<String>>(subject: S) -> Self {
        Self::NotAvailable(format!("{} not available", subject.into()))
    }
}
...
impl Writer for AppError {
    async fn write(mut self, _req: &mut Request, _depot: &mut Depot, res: &mut Response) {
        ...
        let data = match self {
            ...
            Self::NotAvailable(msg) => StatusError::not_found().brief(msg),
            Self::Internal(msg) => {
